	...
	<div class="container">
		<div>
			...
			<form action="addNewDish" method="post">
				<input type="submit" name="submit" value="Add New Dish"
							...
							<div class="media-body">
								...
								<div align="left">
									...
									<form method="post" action="discuss">
										<p align="right">
											<input
												type="button" class="btn btn-default" name="${da.dish.id}"
												onclick="likeFuncation(${da.dish.id})"
												value="Like (${da.hl.size()})" /> <input type="submit"
												class="btn btn-default" name="submit" value="discuss">
